                  ...
                  <v-layout wrap>
                    ...
                    <v-flex>
                      <v-text-field
                        ...
                        data-vv-name="ประเภทสินค้าที่ต้องการ"
                        v-validate="'required|min:2'"
                        :error-messages="errors.collect('ประเภทสินค้าที่ต้องการ')"
...
export default {
  data: () => ({
    //--start config
    service: "product",
    objectName: "ประเภทสินค้า",
    headers: [
      { value: "Id", text: "Id", sortable: true },
      { value: "Name", text: "รายละเอียดสินค้า", sortable: true },
      { text: "", sortable: false }
    ],
    defaultValue: {
      Name: ""
