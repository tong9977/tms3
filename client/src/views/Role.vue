                  ...
                  <v-layout wrap>
                    ...
                    <v-flex>
                      <v-text-field
                        ...
                        data-vv-name="ประเภทผู้ใช้งาน"
                        v-validate="'required|min:2'"
                        :error-messages="errors.collect('ประเภทผู้ใช้งาน')"
                        label="กรอกประเภทผู้ใช้งาน"
                      ></v-text-field>
                    </v-flex>
                  </v-layout>
                </v-container>
...
export default {
  data: () => ({
    //--start config
    service: "role",
    objectName: "ประเภทผู้ใช้งาน",
    headers: [
      { value: "Id", text: "Id", sortable: true },
      { value: "RoleName", text: "ประเภทผู้ใช้", sortable: true },
      { text: "", sortable: false }
    ],
    defaultValue: {
      RoleName: ""
