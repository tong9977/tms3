                  ...
                  <v-layout wrap>
                    ...
                    <v-flex>
                      <v-text-field
                        ...
                        data-vv-name="ประเภทคำถามที่ต้องการ"
                        v-validate="'required|min:2'"
                        :error-messages="errors.collect('ประเภทคำถามที่ต้องการ')"
                        label="ประเภทคำถามที่ต้องการ"
                      ></v-text-field>
                    </v-flex>
                  </v-layout>
                </v-container>
...
export default {
  data: () => ({
    ...
    objectName: "ประเภทคำถาม",
    headers: [
      { value: "Id", text: "Id", sortable: true },
      { value: "Question", text: "รายละเอียดคำถาม", sortable: true },
      { text: "", sortable: false }
    ],
    defaultValue: {
      Question: ""
